...
namespace WorkIdentityNetCore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required]                                                                                    // you can delete this bullshit
            [StringLength(100, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 6)]// <- delete this 
            [DataType(DataType.Password)]                                                                 // we acutally dont need this minimum lenght...
